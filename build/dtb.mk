...
dtb: | ensure-output-dirs
	...
	dtc -I dts -O dtb \
		"$(DTB_SOURCE_DIR)/dts/hi1910b/hi1910BL/hi1910B-orangepiaipro20t-24g.dts" \
		-o "$(OUTPUT_DIR)/hi1910B-orangepiaipro20t-24g.dtb"
	dtc -I dts -O dtb \
	...
	printf 'generate %s/hi1910B-orangepiaipro20t-24g.dtb success\n' "$(OUTPUT_DIR)"

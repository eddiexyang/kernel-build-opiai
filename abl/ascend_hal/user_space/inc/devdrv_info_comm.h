...
/* phy gpio pin 262 sofy pin 338 */
#define DEVDRV_MDC_GPIO_SLOT_ID 262
...
#define DEVDRV_IPV6_ARRAY_LEN (4)
...
typedef union _dmanager_ipaddr {
    ...
    unsigned int addr_v6[DEVDRV_IPV6_ARRAY_LEN];
} ipaddr_t;
...
int devdrv_imu_dmp_msg_send(int fd, unsigned int dev_id, unsigned char *buf, unsigned char len);
int devdrv_imu_dmp_msg_recv(int fd, unsigned int dev_id, unsigned char *buf, unsigned char buf_len,
...
int dmanage_set_power_state(int device_id, DSMI_POWER_STATE type);
...
int dmanage_get_emu_subsys_status(int device_id, struct dsmi_emu_subsys_state_stru *emu_subsys_state_data);
int dmanage_get_safetyisland_status(int device_id, struct dsmi_safetyisland_status_stru *safetyisland_status_data);
int dmanage_get_power_state(unsigned int device_id, unsigned int vfid, unsigned int sub_cmd, void *buf,
    unsigned int *size);
int dmanage_get_info_from_lp(unsigned int dev_id, unsigned int vfid, unsigned int sub_cmd, void *out_buf,
    unsigned int *buf_size);
int dmanage_get_sils_info(unsigned int device_id, unsigned int vfid, unsigned int sub_cmd, void *buf,
    unsigned int *size);
int dmanage_set_sils_info(unsigned int device_id, unsigned int sub_cmd, void *buf, unsigned int size);
#endif
...
drvError_t drvPciehotReset(uint32_t devId);
drvError_t drvPciehotResetV2(uint32_t devId, unsigned int flag);
...
* ---------------------------------------------------------------------------------------------------------
* TARGET_ID_LP           | IPC_MAIN_CMD_QUERY  | IPC_SUB_CMD_SOC_TEMP   | ascend310,ascend610,ascend310p   |
* TARGET_ID_LP           | IPC_MAIN_CMD_QUERY  | IPC_SUB_CMD_AIC0_FREQ  | ascend610,ascend310p             |
* TARGET_ID_LP           | IPC_MAIN_CMD_QUERY  | IPC_SUB_CMD_AIC1_FREQ  | ascend610,ascend310p             |
* TARGET_ID_LP           | IPC_MAIN_CMD_QUERY  | IPC_SUB_CMD_CCPU_FREQ  | ascend610,ascend310p             |
* TARGET_ID_LP           | IPC_MAIN_CMD_QUERY  | IPC_SUB_CMD_DDR_FREQ   | ascend310,ascend610,ascend310p   |
* ---------------------------------------------------------------------------------------------------------

...
STATIC void devdrv_dfm_dump(u32 excep_id, u32 etype, u32 module_id, char **black_box_info)
{
...
STATIC void devdrv_dfm_dump_ex(u32 excep_id, u32 etype, u32 module_id, char **black_box_info)
{
    return;
}
...
int devdrv_black_box_init(void)
{
    ...
    if (ret) {
        devdrv_drv_err("dfm_register_module failed.\n");
        return -1;
    }

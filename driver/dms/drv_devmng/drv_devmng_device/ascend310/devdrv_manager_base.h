...
#define SOC_TS_SYSCTRL0_REG               (SOC_TS_BASE + 0x1F0030000)
#define SOC_TS_DOORBELL_CFG_REG           (SOC_TS_BASE + 0x1F0400000)
#define SOC_TS_SRAM_REG                   (SOC_TS_BASE + 0x1F0200000)
...
#define DEVDRV_MANAGER_TS_DOORBELL_REG              SOC_TS_DOORBELL_CFG_REG
#define DEVDRV_MANAGER_TS_DOORBELL_SIZE             0x400000
#define DEVDRV_MANAGER_TS_SRAM_REG                  SOC_TS_SRAM_REG

...
#else
#define MAX_VDEV_NUM                    (256)
#define VDAVINCI_MAX_VFID_NUM           (16)
#define VDAVINCI_MAX_DEVICE_COUNT       (16)
#endif
...
#define DIE_BASEADDR_HIGH_OFFSET_WITHIN_2G  (0x1000000000ULL) /* die id is larger than 0, need to add high offset */
...
#define EMU_STATUS_BIT_WIDTH 2
#define CHAR_BIT_WIDTH 8
#define ERROR_CODE_OFFSET_IN_PAYLOAD 0
#define EMU_NUM_OFFSET_IN_PAYLOAD 1
#define SAFETY_ISLAND_STATUS_OFFSET_IN_PAYLOAD 1
#define EMU_STATUS_OFFSET_IN_PAYLOAD 2
#define DRVFAULT_IPC_MSG_LENGTH 22
#define STATUS_NUM_PER_BYTE 4
#define EMU_STATUS_BIT_MASK 3
#define ADDR_OFFSET_2G 0x80000000
...
enum devdrv_arch_type {
    ARCH_BEGIN = 0,
    ARCH_V100 = ARCH_BEGIN, /* Ascend310，Ascend910，Ascend910B Ascend910C used value */
    ARCH_V200,     /* Ascend310P */
    ARCH_V300,     /* Ascend310B */
    ARCH_C100 = 3, /* Ascend910 real value */
    ARCH_C220 = 4, /* Ascend910B & Ascend910C real value */
    ARCH_M100 = 5, /* Ascend310 real value */
    ARCH_M200 = 6, /* Ascend610 */
    ARCH_M201 = 7, /* BS9SX1A */
    ARCH_T300 = 8, /* Tiny */
    ARCH_N350 = 9, /* Nano */
    ARCH_M300 = 10, /* AS31XM1X */
...
enum devdrv_hardware_version {
    ...
    DEVDRV_PLATFORM_ASCEND610 = PLAT_COMBINE(ARCH_M200, CHIP_MDC, VER_NA),
    DEVDRV_PLATFORM_ASCEND610LITE = PLAT_COMBINE(ARCH_M310, CHIP_MDC, VER_610LITE),
    ...
    DEVDRV_PLATFORM_BS9SX1A = PLAT_COMBINE(ARCH_M201, CHIP_MDC, VER_CS),
    DEVDRV_PLATFORM_AS31XM1 = PLAT_COMBINE(ARCH_M300, CHIP_MDC, VER_AS31XM1),
    ...
    DEVDRV_PLATFORM_CLOUD_V2_C1 = PLAT_COMBINE(ARCH_V100, CHIP_CLOUD_V2, VER_BIN5),
    DEVDRV_PLATFORM_CLOUD_V2_C2 = PLAT_COMBINE(ARCH_V100, CHIP_CLOUD_V2, VER_BIN6),
    DEVDRV_PLATFORM_CLOUD_V2_C3 = PLAT_COMBINE(ARCH_V100, CHIP_CLOUD_V2, VER_BIN7),
...
enum ipcTargetId {
    ...
    TARGET_ID_TSC,
    TARGET_ID_TSV,           /**< only in 610 */
    TARGET_ID_SAFETYISLAND,  /**< only in 610 */
    MAX_TARGET_ID
};
...
struct devdrv_chip_list {
    int count;
    int chip_list[DEVDRV_MAX_CHIP_NUM];
};

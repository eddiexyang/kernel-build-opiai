...
LOCAL_DEPEND_KO:=ascend_trs_sub_stars ascend_trs_core ascend_trs_nvme_chan ascend_trs_id_allocator ascend_soc_resmng drv_devmng_host ascend_uda ascend_urd
LOCAL_KBUILD_EXTRA_SYMBOLS := \
	$(PWD)/$(DEVICE_OUT_INTERMEDIATES)/drv_pcie_ko/Module.symvers \
	$(PWD)/$(DEVICE_OUT_INTERMEDIATES)/ascend_trs_stars_ko/Module.symvers

...
#define TRS_RSV_HW_SQCQ_NUM         0

#define TRS_HOST_CQ_GROUP_NUM       1
...
#define TRS_DB_TASK_SQ_START        0u
#define TRS_DB_TASK_SQ_END          512u

#define TRS_DB_TASK_CQ_START        512u
#define TRS_DB_TASK_CQ_END          864u
...
static inline void trs_get_task_sq_db_cfg(u32 phy_devid, u32 tsid, u32 *start, u32 *end)
{
    *start = TRS_DB_TASK_SQ_START;
    *end = TRS_DB_TASK_SQ_END;
}

static inline void trs_get_task_cq_db_cfg(u32 phy_devid, u32 tsid, u32 *start, u32 *end)
{
    *start = TRS_DB_TASK_CQ_START;
    *end = TRS_DB_TASK_CQ_END;
}

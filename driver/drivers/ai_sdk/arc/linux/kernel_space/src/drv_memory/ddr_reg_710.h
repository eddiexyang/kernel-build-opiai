...
#ifndef DRV_MEMORY_DDR_REG_710_H
#define DRV_MEMORY_DDR_REG_710_H
...
#define DDR_CHAN_BITMAP 0x00FFFFFF
#define DDRC_FLUX_MB_DIV 65536
#define DDRC_DQ_NUM 384
#define DDRC_FREQ_DOUBLE 2

#define DDRC_CHIP_REG_BASE_OFFSET 0x8000000000
...
#define MEMORY_SHAREMEM_BASE_ADDR  0
#define DDR_CHAN_MASK_IOREMAP_ADDR    0x3120000CU

...
#define SOC_MISC_SENSOR_EMMC_NUM 1
...
STATIC struct dms_node_operations g_soc_misc_emmc_ops = {
    .init = soc_misc_emmc_ops_init,
    .uninit = soc_misc_emmc_ops_uninit,
    .scan = NULL,
    .fault_diag = NULL,
    .event_notify = NULL,
    .get_link_state = NULL,
...
#define SOC_MISC_EMMC_NODES(_dev_id) { \
    SOC_MISC_EMMC_NODE(_dev_id, 0),  \
    SOC_MISC_EMMC_NODE(_dev_id, 1),  \
    SOC_MISC_EMMC_NODE(_dev_id, 2),  \
    SOC_MISC_EMMC_NODE(_dev_id, 3),  \
}
...
STATIC struct dms_sensor_object_cfg
g_soc_misc_emmc_sensor_table[SOC_MISC_DEVICE_NUM_MAX][SOC_MISC_MAX_NODE_NUM][SOC_MISC_SENSOR_EMMC_NUM] = {
    { /* dev_node 0 */
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_0, 0, DMS_SEN_TYPE_RAS_SENSOR, "emmc_local", soc_misc_emmc_sensor_scan) },
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_0, 1, DMS_SEN_TYPE_RAS_SENSOR, "emmc_local", soc_misc_emmc_sensor_scan) },
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_0, 2, DMS_SEN_TYPE_RAS_SENSOR, "emmc_local", soc_misc_emmc_sensor_scan) },
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_0, 3, DMS_SEN_TYPE_RAS_SENSOR, "emmc_local", soc_misc_emmc_sensor_scan) },
    }, { /* dev_node 1 */
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_1, 0, DMS_SEN_TYPE_RAS_SENSOR, "emmc_local", soc_misc_emmc_sensor_scan) },
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_1, 1, DMS_SEN_TYPE_RAS_SENSOR, "emmc_local", soc_misc_emmc_sensor_scan) },
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_1, 2, DMS_SEN_TYPE_RAS_SENSOR, "emmc_local", soc_misc_emmc_sensor_scan) },
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_1, 3, DMS_SEN_TYPE_RAS_SENSOR, "emmc_local", soc_misc_emmc_sensor_scan) },
    },
};
#endif // CFG_FEATURE_EMMC_HISI_COMM_FAULT

#endif // CFG_FEATURE_BASE_FAULT

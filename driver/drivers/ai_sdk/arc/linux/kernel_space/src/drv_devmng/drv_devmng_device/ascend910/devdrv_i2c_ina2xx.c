...
#define INA226_SHUNT_DIV  400
#define INA226_POWER_LSB  25000
#define INA226_BUS_VOLTAGE_LSB    1250
#define INA226_CALIBRATION_FACTOR 5120000

STATIC const struct ina2xx_config ina2xx_config[] = {
    [INA226] = {
        .config_default = INA226_CONFIG_DEFAULT,
        .calibration_factor = INA226_CALIBRATION_FACTOR,
        .registers = INA226_REGISTERS,
        .shunt_div = INA226_SHUNT_DIV,
        .bus_voltage_shift = 0,
        .bus_voltage_lsb = INA226_BUS_VOLTAGE_LSB,
        .power_lsb = INA226_POWER_LSB,
    },
};
...
STATIC int ina226_reg_to_interval(u16 config)
{
     ...
     */
    return DIV_ROUND_CLOSEST((avg * INA226_TOTAL_CONV_TIME_DEFAULT), 1000);  // divisor is 1000
}
...
STATIC int ina2xx_do_update(u8 reg)
{
    ...
    for (retry = 5; retry; retry--) {
        /*
         * Read registers.
         * The function i2c_smbus_read_word_swapped returns a negative value or U16.
         */
...
int ina2xx_get_value(u8 reg, int *result)
{
    ...
    if ((result == NULL) || (data == NULL)) {
        devdrv_drv_err("invalid param, (result == NULL)=%d, (data == NULL)=%d.\n", (result == NULL), (data == NULL));
        return -ENODEV;
    }
    ...
    switch (reg) {
        ...
        case INA2XX_BUS_VOLTAGE:
            ...
            val = DIV_ROUND_CLOSEST(val, 1000); // divisor is 1000
            break;
        case INA2XX_POWER:
            val = DIV_ROUND_CLOSEST(((int)data->regs[reg] * data->config->power_lsb), 1000); // divisor is 1000
            break;
        case INA2XX_CURRENT:

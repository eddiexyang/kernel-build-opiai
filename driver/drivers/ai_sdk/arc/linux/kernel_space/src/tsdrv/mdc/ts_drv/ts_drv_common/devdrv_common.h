...
#define devdrv_drv_debug(fmt, ...) drv_pr_debug(module_devdrv, "<%s:%d> " fmt,      \
...
struct tsdrv_drv_ops {
    ...
    int (*add_ipc_event_msg_chan)(u32 devid, u32 tsid, struct tsdrv_msg_resource_id *dev_msg_resource_id);

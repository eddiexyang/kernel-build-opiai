...
#define TSDRV_MBOX_ALLOC_RUNTIME_STREAM_ID   41U  /* 40 alloc runtime stream id for BS9SX1A */
#define TSDRV_MBOX_FREE_RUNTIME_STREAM_ID    42U  /* 41 free runtime stream id for BS9SX1A */

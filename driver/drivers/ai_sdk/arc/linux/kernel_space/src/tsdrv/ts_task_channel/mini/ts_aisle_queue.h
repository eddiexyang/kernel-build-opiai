 ...
 * Create: 2019-10-15
 */
#ifndef HWTS_DRV_QUEUE_H
#define HWTS_DRV_QUEUE_H
...
#define AICPU_TO_TS_SRAM_ADDR_SQ 0x1F0200100
#define AICPU_TO_TS_SRAM_ADDR_SQ_LEN 0x800
#define AICPU_TO_TS_SRAM_ADDR_CQ 0x1F0200900
#define AICPU_TO_TS_SRAM_ADDR_CQ_LEN 0x400
#define AICPU_TO_TS_MSG_CHAN_SQ_DEPTH \
    ((AICPU_TO_TS_SRAM_ADDR_SQ_LEN - AICPU_TO_TS_SRAM_Q_HEAD) / AICPU_TO_TS_MSG_CHAN_QE_LENGTH)
#define AICPU_TO_TS_MSG_CHAN_CQ_DEPTH \
    ((AICPU_TO_TS_SRAM_ADDR_CQ_LEN - AICPU_TO_TS_SRAM_Q_HEAD) / AICPU_TO_TS_MSG_CHAN_QE_LENGTH)

#define TS_AICPU_IRQ_INDEX 16
#define AICPU_TO_TS_SQ_IRQ 327

#define GICD_ISPENDR 0x0200
#define REG_LEN 32
#define REG_ALIGN 4

typedef void (*queue_call_back)(unsigned int irq);
...
extern aicpu_to_ts_msg_cb g_aicpu_to_ts_cb;

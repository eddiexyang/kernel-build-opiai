...
#define DEVDRV_RX_ATU_NUM 16
#define DEVDRV_TX_ATU_NUM 4

#define DEVDRV_SUPPORT_MAX_VF_NUM 0

#define DEVDRV_PCIE_DDR_SIZE 0x4000000000ULL
#ifdef CFG_SOC_PLATFORM_ESL_FPGA
#define DEVDRV_P2P_SUPPORT_MAX_DEVICE 4
#define DEVDRV_H2D_SUPPORT_MAX_DEVICE 4
#else

...
static struct m24256_dev *i2c_dev_array[EEPROM_I2C_MINORS] = {NULL};

static const struct i2c_device_id m24256_idtable[] = {
    { "eeprom_m24256", 0 },
    { "eeprom_m24256_mini", 0 },
    { }
};

/*lint -e508 */
MODULE_DEVICE_TABLE(i2c, m24256_idtable); /*lint +e508 */

STATIC struct m24256_dev *get_free_i2c_dev(struct i2c_adapter *adap)
{
    ...
    i2c_dev = kzalloc(sizeof(struct m24256_dev), GFP_KERNEL);
    if (i2c_dev == NULL) {
...
STATIC int return_i2c_dev(struct m24256_dev *i2c_dev)
{
    if (i2c_dev == NULL) {
...
STATIC struct m24256_dev *i2c_dev_get_by_minor(unsigned index)
{
    struct m24256_dev *i2c_dev = NULL;
...
STATIC int eeprom_release(struct inode *node, struct file *file)
{
    ...
    i2c_dev = (struct m24256_dev *)file->private_data;
    if (i2c_dev == NULL) {
        eeprom_err("invalid parameter,i2c_dev == NULL\n");
        return -1;
    }
...
{
    struct m24256_dev *i2c_dev = (struct m24256_dev *)filp->private_data;
...
{
    struct m24256_dev *i2c_dev = (struct m24256_dev *)file->private_data;
    struct i2c_client *client = i2c_dev->client;
...
STATIC int eeprom_probe(struct i2c_client *client)
{
    ...
    if (i2c_dev->minor == 0) {
        ...
        node_device[i2c_dev->minor] =
            device_create(cls, NULL, devno + i2c_dev->minor, NULL, "eeprom_m24256-%d", i2c_dev->minor);
    }

...
typedef struct {
    ...
    td_u8            ieee_out[((td_s32)SCDC_OFFSET_IEEE_OUI_1ST - (td_s32)SCDC_OFFSET_IEEE_OUI_3TH) + 1];
    td_u8            device_id[((td_s32)SCDC_OFFSET_DEVICE_ID_TAIL - (td_s32)SCDC_OFFSET_DEVICE_ID_HEAD) + 1];

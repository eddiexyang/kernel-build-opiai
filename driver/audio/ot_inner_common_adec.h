 ...
 * Description: ot_inner_common_adec.h
 * Author: Hisilicon multimedia software group
 * Create: 2019/06/15
 */

#ifndef  OT_INNER_COMMON_ADEC_H
#define  OT_INNER_COMMON_ADEC_H
...
typedef struct {
    ...
    td_u32          buf_size;   /* buf size[2~OT_MAX_ADEC_AENC_FRAME_NUM] */
...
#endif /* End of #ifndef OT_INNER_COMMON_ADEC_H */

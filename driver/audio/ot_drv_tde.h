...
/* tde start err no. */
#define DRV_ERR_TDE_BASE ((td_s32)(((0x80UL + 0x20UL) << 24U) | (100U << 16U) | (4U << 13U) | 1U))

#define DRV_ERR_TDE_DEV_NOT_OPEN            (DRV_ERR_TDE_BASE)      /* tde device not open yet */
#define DRV_ERR_TDE_DEV_OPEN_FAILED         (DRV_ERR_TDE_BASE + 1)  /* open tde device failed */
#define DRV_ERR_TDE_NULL_PTR                (DRV_ERR_TDE_BASE + 2)  /* input parameters contain null ptr */
#define DRV_ERR_TDE_NO_MEM                  (DRV_ERR_TDE_BASE + 3)  /* malloc failed  */
#define DRV_ERR_TDE_INVALID_HANDLE          (DRV_ERR_TDE_BASE + 4)  /* invalid job handle */
#define DRV_ERR_TDE_INVALID_PARA            (DRV_ERR_TDE_BASE + 5)  /* invalid parameter */
#define DRV_ERR_TDE_NOT_ALIGNED             (DRV_ERR_TDE_BASE + 6)  /* aligned error for position, stride, width */
#define DRV_ERR_TDE_MINIFICATION            (DRV_ERR_TDE_BASE + 7)  /* invalid minification */
/* clip area and operation area have no intersection */
#define DRV_ERR_TDE_CLIP_AREA               (DRV_ERR_TDE_BASE + 8)
#define DRV_ERR_TDE_JOB_TIMEOUT             (DRV_ERR_TDE_BASE + 9)  /* blocked job wait timeout */
#define DRV_ERR_TDE_UNSUPPORTED_OPERATION   (DRV_ERR_TDE_BASE + 10) /* unsupported operation */
#define DRV_ERR_TDE_QUERY_TIMEOUT           (DRV_ERR_TDE_BASE + 11) /* query time out */
#define DRV_ERR_TDE_INTERRUPT               (DRV_ERR_TDE_BASE + 12) /* blocked job was interrupted */
#define DRV_ERR_TDE_BUTT                    (DRV_ERR_TDE_BASE + 13)

...
/*****************************************************************************
 ...
 return value : hi_s32
                ...
                failure : not 0
*****************************************************************************/
extern hi_s32 vb_put_blk(hi_u32 pool_id, hi_u64 phys_addr);
...
/*****************************************************************************
 prototype    : vb_phy_to_handle_with_id
 Description  : convert physical address to handle
 input        : pool_id      : ID of pool in which the buffer is.
                phys_addr    : physical address of the buffer
 output       :
 return value : vb_blk_handle
******************************************************************************/
extern vb_blk_handle vb_phy_to_handle_with_id(hi_u32 pool_id, hi_u64 phy_addr);
...
/*****************************************************************************
 ...
 input        : pool_id      : ID of pool the buffer is in
                phys_addr    : physcial addr of the buffer
                uid         : ID of the user
 output       :
 return value : hi_s32
                success    : 0
                failure    : not 0
*****************************************************************************/
extern hi_s32 vb_user_add(hi_u32 pool_id, hi_u64 phys_addr, hi_u32 uid);
...
/*****************************************************************************
 ...
 return value : hi_s32
*****************************************************************************/
extern hi_s32 vb_user_sub(hi_u32 pool_id, hi_u64 phys_addr, hi_u32 uid);
...
#ifdef __LITEOS__
static inline hi_s32 vb_init(hi_void)
{
    return 0;
}

static inline hi_s32 vb_exit(hi_void)
{
    return 0;
}
#else
...
*****************************************************************************/
extern hi_void vb_copy_supplement(const hi_video_frame *dst_v_frame, const hi_video_frame *src_v_frame);

typedef struct {
    hi_s32 (*pfn_vb_create_pool)(hi_u32 *pool_id, hi_u32 blk_cnt, hi_u64 blk_size,
                                 const hi_char *pc_mmz_name, const hi_char *buf_name,
                                 hi_vb_remap_mode vb_remap_mode, struct media_mem_file *mfile, hi_u32 device_id);
    ...
    vb_blk_handle (*pfn_vb_phy_to_handle_with_id)(hi_u32 pool_id, hi_u64 phy_addr);
    ...
    hi_void (*pfn_vb_copy_supplement)(const hi_video_frame *dst_v_frame, const hi_video_frame *src_v_frame);
    hi_void (*pfn_vb_copy_supplement_with_id)(hi_u32 dst_pool_id, const hi_video_frame *dst_v_frame,
        hi_u32 src_pool_id, const hi_video_frame *src_v_frame);
    hi_u64 (*pfn_vb_handle_to_buf_handle)(vb_blk_handle handle);
    hi_s32 (*pfn_vb_get_buf_handle)(hi_u32 pool_id, hi_u64 phy_addr, hi_u64 *mbuf_handle);
    hi_s32 (*pfn_vb_destroy_pool_by_mmzname)(const hi_char* mmz_name, hi_u32 len);
    hi_s32 (*pfn_vb_create_empty_pool)(unsigned long arg);
    hi_s32 (*pfn_vb_try_destroy_pool)(unsigned long arg);
    hi_s32 (*pfn_vb_set_pool_buf)(unsigned long arg);
    hi_s32 (*pfn_vb_get_pool_buf)(unsigned long arg);
} vb_export_func;

#define ckfn_vb_create_pool() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_create_pool != NULL))
#define call_vb_create_pool(pool_id, blk_cnt, blk_size, pc_mmz_name, buf_name, vb_remap_mode, mfile, device_id) \
    FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_create_pool((pool_id), (blk_cnt), (blk_size), \
                                                            (pc_mmz_name), (buf_name), (vb_remap_mode), \
                                                            (mfile), (device_id))

#define ckfn_vb_create_empty_pool() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_create_empty_pool != NULL))
#define call_vb_create_empty_pool(arg) \
    FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_create_empty_pool((arg))

#define ckfn_vb_destroy_pool() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_destroy_pool != NULL))
#define call_vb_destroy_pool(pool_id) \
    FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_destroy_pool((pool_id))

#define ckfn_vb_try_destroy_pool() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_try_destroy_pool != NULL))
#define call_vb_try_destroy_pool(arg) \
    FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_try_destroy_pool((arg))

#define ckfn_vb_set_pool_buf() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_set_pool_buf != NULL))
#define call_vb_set_pool_buf(arg) \
    FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_set_pool_buf((arg))

#define ckfn_vb_get_pool_buf() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_get_pool_buf != NULL))
#define call_vb_get_pool_buf(arg) \
    FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_get_pool_buf((arg))

#define ckfn_vb_destroy_pool_by_mmzname() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_destroy_pool_by_mmzname != NULL))
#define call_vb_destroy_pool_by_mmzname(mmz_name, len) \
    FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_destroy_pool_by_mmzname((mmz_name), (len))

#define ckfn_vb_get_blk_by_pool_id() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_get_blk_by_pool_id != NULL))
...
#define ckfn_vb_get_blk_by_size() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_get_blk_by_size != NULL))
...
#define ckfn_vb_get_blk_by_size_and_module() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_get_blk_by_size_and_module != NULL))
...
#define ckfn_vb_get_blk_by_size_and_pool_id() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_get_blk_by_size_and_pool_id != NULL))
...
#define ckfn_vb_get_pool_id() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_get_pool_id != NULL))
...
#define ckfn_vb_get_pool_info() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_get_pool_info != NULL))
#define call_vb_get_pool_info(info) \
    FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_get_pool_info((info))

#define ckfn_vb_put_blk() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_put_blk != NULL))
...
#define ckfn_vb_phy_to_handle() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_phy_to_handle != NULL))
#define call_vb_phy_to_handle(phy_addr) \
    FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_phy_to_handle((phy_addr))

#define ckfn_vb_phy_to_handle_with_id() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_phy_to_handle_with_id != NULL))
#define call_vb_phy_to_handle_with_id(pool_id, phy_addr) \
    FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_phy_to_handle_with_id((pool_id), (phy_addr))

#define ckfn_vb_handle_to_pool_id() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_handle_to_pool_id != NULL))
...
#define ckfn_vb_handle_to_blk_id() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_handle_to_blk_id != NULL))
...
#define ckfn_vb_handle_to_kern() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_handle_to_kern != NULL))
...
#define ckfn_vb_handle_to_phys() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_handle_to_phys != NULL))
...
#define ckfn_vb_handle_to_blk_size() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_handle_to_blk_size != NULL))
...
#define ckfn_vb_user_add() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_user_add != NULL))
...
#define ckfn_vb_user_sub() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_user_sub != NULL))
...
#define ckfn_vb_inquire_user_cnt() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_inquire_user_cnt != NULL))
...
#define ckfn_vb_inquire_one_user_cnt() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_inquire_one_user_cnt != NULL))
...
#define ckfn_vb_inquire_total_user_cnt() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_inquire_total_user_cnt != NULL))
...
#define ckfn_vb_inquire_blk_cnt() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_inquire_blk_cnt != NULL))
...
#define ckfn_vb_is_blk_valid() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_is_blk_valid != NULL))
...
#define ckfn_vb_is_pool_id_valid() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_is_pool_id_valid != NULL))
...
#define ckfn_vb_inquire_pool() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_inquire_pool != NULL))
...
#define ckfn_vb_inquire_pool_user_cnt() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_inquire_pool_user_cnt != NULL))
...
#define ckfn_vb_handle_to_supplement() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_handle_to_supplement != NULL))
...
#define ckfn_vb_is_supplement_support() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_is_supplement_support != NULL))
...
#define ckfn_vb_copy_supplement() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_copy_supplement != NULL))
...
#define ckfn_vb_copy_supplement_with_id() \
    (CHECK_FUNC_ENTRY(HI_ID_VB) && (FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_copy_supplement_with_id != NULL))
#define call_vb_copy_supplement_with_id(dst_pool_id, dst_v_frame, src_pool_id, src_v_frame) \
    FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_copy_supplement_with_id((dst_pool_id), \
    (dst_v_frame), (src_pool_id), (src_v_frame))

#define call_vb_get_buf_handle(pool_id, phy_addr, mbuf_handle) \
    FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_get_buf_handle((pool_id), (phy_addr), (mbuf_handle))
#define call_vb_handle_to_buf_handle(handle) \
    FUNC_ENTRY(vb_export_func, HI_ID_VB)->pfn_vb_handle_to_buf_handle((handle))

 ...
 * Description: ot_inner_common_aio.h
...
#define OT_MAX_AUDIO_FRAME_NUM     300      /* max count of audio ai/ao in Buffer */
...
#define OT_SND_MODE_STEREO 0
#define OT_SND_MODE_MONO_L 1
#define OT_SND_MODE_MONO_R 2
#define OT_SND_MODE_BUTT 3
...
typedef struct {
    ...
    struct media_mem_file ai_mem_file;
    struct media_mem_file ao_mem_file;
    td_u32 smmu_audio_flag;
} ot_aio_attr;
...
/* vqe register err */
#define OT_ERR_AIO_REGISTER_ERR     OT_DEFINE_ERR(OT_ID_AIO, OT_ERR_LEVEL_ERROR, OT_ERR_REG)

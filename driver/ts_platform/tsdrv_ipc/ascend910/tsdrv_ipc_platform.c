...
static struct tsdrv_ipc_chan g_ipc_chan_table[DEVDRV_MAX_DAVINCI_NUM][HISI_RPROC_MAX] = {
    {
        {0, 0, "TSC_RX_RPID4", HISI_RPROC_TX_TS_MBX17, HISI_RPROC_RX_TS_MBX2},

        /* end of array. */
        {0, 0, NULL, HISI_RPROC_MAX, HISI_RPROC_MAX},
    },
    {
        {1, 0, "TSC_RX_RPID4", HISI_RPROC_TX_TS_MBX17, HISI_RPROC_RX_TS_MBX2},

        /* end of array. */
        {0, 0, NULL, HISI_RPROC_MAX, HISI_RPROC_MAX},
    },
    {
        {2, 0, "TSC_RX_RPID4", HISI_RPROC_TX_TS_MBX17, HISI_RPROC_RX_TS_MBX2},

        /* end of array. */
        {0, 0, NULL, HISI_RPROC_MAX, HISI_RPROC_MAX},
    },
    {
        {3, 0, "TSC_RX_RPID4", HISI_RPROC_TX_TS_MBX17, HISI_RPROC_RX_TS_MBX2},

...
STATIC void devdrv_device_remove_no_tsnode(struct platform_device *pdev, struct devdrv_info *dev_info,
...
/* Forward declarations for cross-module APIs (resolved at link time via Module.symvers) */

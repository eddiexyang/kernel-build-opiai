...
typedef struct {
    ...
    td_bool         audio_mute;
    td_bool         video_mute;
    td_bool         if_enable[(td_s32)HDMI_INFOFRAME_TYPE_BUTT - (td_s32)HDMI_INFOFRAME_TYPE_VENDOR];
    td_bool         if_data[(td_s32)HDMI_INFOFRAME_TYPE_BUTT
                    - (td_s32)HDMI_INFOFRAME_TYPE_VENDOR][HDMI_INFOFRMAE_MAX_SIZE];

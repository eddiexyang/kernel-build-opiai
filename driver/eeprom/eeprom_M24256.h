 ...
 * Create: 2019-10-15
 */
#ifndef __EEPROM_M24256_H__
#define __EEPROM_M24256_H__
...
#define EEPROM_MAX_ADDR 0x7fff /* 256Kbit equal to 32Kbyte */
...
STATIC struct m24256_dev *i2c_dev_get_by_adapter(struct i2c_adapter *adap);

...
u32 biu_channel_id[MILAN_BIU_CHANNEL_SUM] = {
    CHANNEL_BIU_GROUP0_AIC, CHANNEL_BIU_GROUP0_AIV0, CHANNEL_BIU_GROUP0_AIV1,
    CHANNEL_BIU_GROUP1_AIC, CHANNEL_BIU_GROUP1_AIV0, CHANNEL_BIU_GROUP1_AIV1,
    CHANNEL_BIU_GROUP2_AIC, CHANNEL_BIU_GROUP2_AIV0, CHANNEL_BIU_GROUP2_AIV1,
    CHANNEL_BIU_GROUP3_AIC, CHANNEL_BIU_GROUP3_AIV0, CHANNEL_BIU_GROUP3_AIV1,
    CHANNEL_BIU_GROUP4_AIC, CHANNEL_BIU_GROUP4_AIV0, CHANNEL_BIU_GROUP4_AIV1,
    CHANNEL_BIU_GROUP5_AIC, CHANNEL_BIU_GROUP5_AIV0, CHANNEL_BIU_GROUP5_AIV1,
    CHANNEL_BIU_GROUP6_AIC, CHANNEL_BIU_GROUP6_AIV0, CHANNEL_BIU_GROUP6_AIV1,
    CHANNEL_BIU_GROUP7_AIC, CHANNEL_BIU_GROUP7_AIV0, CHANNEL_BIU_GROUP7_AIV1,
    CHANNEL_BIU_GROUP8_AIC, CHANNEL_BIU_GROUP8_AIV0, CHANNEL_BIU_GROUP8_AIV1,
    CHANNEL_BIU_GROUP9_AIC, CHANNEL_BIU_GROUP9_AIV0, CHANNEL_BIU_GROUP9_AIV1,
    CHANNEL_BIU_GROUP10_AIC, CHANNEL_BIU_GROUP10_AIV0, CHANNEL_BIU_GROUP10_AIV1,
    CHANNEL_BIU_GROUP11_AIC, CHANNEL_BIU_GROUP11_AIV0, CHANNEL_BIU_GROUP11_AIV1,
    CHANNEL_BIU_GROUP12_AIC, CHANNEL_BIU_GROUP12_AIV0, CHANNEL_BIU_GROUP12_AIV1,
    CHANNEL_BIU_GROUP13_AIC, CHANNEL_BIU_GROUP13_AIV0, CHANNEL_BIU_GROUP13_AIV1,
    CHANNEL_BIU_GROUP14_AIC, CHANNEL_BIU_GROUP14_AIV0, CHANNEL_BIU_GROUP14_AIV1,
    CHANNEL_BIU_GROUP15_AIC, CHANNEL_BIU_GROUP15_AIV0, CHANNEL_BIU_GROUP15_AIV1,
    CHANNEL_BIU_GROUP16_AIC, CHANNEL_BIU_GROUP16_AIV0, CHANNEL_BIU_GROUP16_AIV1,
    CHANNEL_BIU_GROUP17_AIC, CHANNEL_BIU_GROUP17_AIV0, CHANNEL_BIU_GROUP17_AIV1,
    CHANNEL_BIU_GROUP18_AIC, CHANNEL_BIU_GROUP18_AIV0, CHANNEL_BIU_GROUP18_AIV1,
    CHANNEL_BIU_GROUP19_AIC, CHANNEL_BIU_GROUP19_AIV0, CHANNEL_BIU_GROUP19_AIV1,
    CHANNEL_BIU_GROUP20_AIC, CHANNEL_BIU_GROUP20_AIV0, CHANNEL_BIU_GROUP20_AIV1,
    CHANNEL_BIU_GROUP21_AIC, CHANNEL_BIU_GROUP21_AIV0, CHANNEL_BIU_GROUP21_AIV1,
    CHANNEL_BIU_GROUP22_AIC, CHANNEL_BIU_GROUP22_AIV0, CHANNEL_BIU_GROUP22_AIV1,
    CHANNEL_BIU_GROUP23_AIC, CHANNEL_BIU_GROUP23_AIV0, CHANNEL_BIU_GROUP23_AIV1,
    CHANNEL_BIU_GROUP24_AIC, CHANNEL_BIU_GROUP24_AIV0, CHANNEL_BIU_GROUP24_AIV1};
...
int prof_hash[CHANNEL_IDS_MAX] = {
    ...
    [CHANNEL_BIU_GROUP0_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP0_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP0_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP1_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP1_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP1_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP2_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP2_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP2_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP3_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP3_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP3_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP4_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP4_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP4_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP5_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP5_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP5_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP6_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP6_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP6_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP7_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP7_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP7_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP8_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP8_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP8_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP9_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP9_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP9_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP10_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP10_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP10_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP11_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP11_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP11_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP12_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP12_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP12_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP13_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP13_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP13_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP14_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP14_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP14_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP15_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP15_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP15_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP16_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP16_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP16_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP17_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP17_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP17_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP18_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP18_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP18_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP19_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP19_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP19_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP20_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP20_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP20_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP21_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP21_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP21_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP22_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP22_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP22_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP23_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP23_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP23_AIV1] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP24_AIC] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP24_AIV0] = PROF_VALID_TSCPU_FLAG,
    [CHANNEL_BIU_GROUP24_AIV1] = PROF_VALID_TSCPU_FLAG,
    ...
    [CHANNEL_LP] = PROF_VALID_PERIPHERAL_VIRTUAL_FLAG,
...
char *prof_peri_cb_regs[CHANNEL_IDS_MAX][PROF_PERI_SAMPLE_MODE_MAX] = {
    ...
    [CHANNEL_LP][PROF_PERI_SAMPLE] = PROF_LP_SAMPLE_FUNC_NAME,
...
STATIC bool prof_channel_is_biu_type(u32 channel_id)
{
    int i;
    for (i = 0; i < MILAN_BIU_CHANNEL_SUM; i++) {
        if (channel_id == biu_channel_id[i]) {
            return true;
        }
    }
    return false;
...
int prof_tscpu_init_channel_info(struct prof_sub_channel_info *sub_channel_info)
{
    ...
    if (prof_channel_is_biu_type(sub_channel_info->channel_id)) {
        sub_channel_info->buf_len = PROF_BIU_TS_BUFFER_LEN;
    } else {
...
void prof_sub_resource_channel_state_init(struct prof_sub_channel_info *sub_channel_info)
{
    sub_channel_info->channel_state = (u32)PROF_CHANNEL_UNINIT;

    if (prof_is_valid_virtual_tscpu_channel(sub_channel_info->channel_id) ||
        prof_is_valid_virtual_peri_channel(sub_channel_info->channel_id) ||
        (prof_is_valid_channel(sub_channel_info->channel_id) && sub_channel_info->sub_channel_id == 0)) {
        sub_channel_info->channel_state = PROF_CHANNEL_IDLE;
    }
}
...
#else
void prof_ut_test_ascd910B(void)
{
}
module_init(prof_ut_test_ascd910B);
#endif

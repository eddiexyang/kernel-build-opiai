...
/* Stubs for DMS framework APIs not yet available */
int __attribute__((weak)) register_driver(const char *name, void *ops, int flags, void *data) { return 0; }
void __attribute__((weak)) unregister_driver(const char *name) {}
int __attribute__((weak)) log_is_ts_valid(void) { return 1; }
int __attribute__((weak)) log_xpc_open_all_channel(void) { return 0; }
int __attribute__((weak)) log_xpc_close_all_channel(void) { return 0; }

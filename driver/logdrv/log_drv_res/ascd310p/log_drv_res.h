...
#define TS0_DUMP_RESERVED_MEM_ADDR (TSCPU1_RESERVED_MEM_ADDR_RUN + LOG_TS_BUFFER_LEN)
#define TSCPU0_RESERVED_MEM_ADDR_RUN (TS0_DUMP_RESERVED_MEM_ADDR + LOG_TS_BUFFER_LEN)
#define TSCPU1_RESERVED_MEM_ADDR_START (TSCPU0_RESERVED_MEM_ADDR_RUN + LOG_TS_BUFFER_LEN)
#define TSCPU0_RESERVED_MEM_ADDR_START (TSCPU1_RESERVED_MEM_ADDR_START + LOG_TS_BUFFER_LEN)
#define TS_DC_CHANNEL_NUM 1

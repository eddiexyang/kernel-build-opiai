...
#define DMS_DECLARE_SEN_TYPE_START(type) struct dms_sensor_type_string _g_event_type_##type[] = {
...
DMS_DECLARE_SEN_TYPE_END;
    ...
    /* 0x13:  Critical I nterrupt Sensor,type:13h,offset:00h-09h,all:10 */
    DMS_DECLARE_SEN_TYPE_START(0x13)
        ...
        {0x09, 0x02, "Fatal NMI (port 61h, bit 7). "},
DMS_DECLARE_SEN_TYPE_END;
...
DMS_DECLARE_SEN_TYPE_END;
    ...
    // 18: OS Boot Sen sor,type:1Fh,offset:00h-06h,all:7
...
DMS_DECLARE_SEN_TYPE_END;
    ...
    /* OS Critica l Stop Sensor,type:20h,00h-01h,all:2 */
    DMS_DECLARE_SEN_TYPE_START(0x20)
        {0x00, 0x03, "Stop during OS load / initialization. "},
        {0x01, 0x03, "Run-time Stop. "},
DMS_DECLARE_SEN_TYPE_END;

    /* Slot  / Con nector Sensor(Sensor Type),type:21h,offset:00h-09h,all:10 */
...
DMS_DECLARE_SEN_TYPE_END;
    ...
    // 23:  Platf orm A lert Sensor,type:24h,offset:00-03,all:4
...
DMS_DECLARE_SEN_TYPE_END;
    ...
    /* Entit y Pre sence Sensor,type:25h,offset:00-02,all:3 */
...
DMS_DECLARE_SEN_TYPE_END;
    ...
    /* Manag ement  Subsystem Health Sensor,type:28h,offset:00-03h,all:4 */
...
DMS_DECLARE_SEN_TYPE_END;
    ...
    /* Batte ry Se nsor,type:29h,offset:00h-02h,all:3 */
...
DMS_DECLARE_SEN_TYPE_END;
    ...
    /* Sessi on Au dit Sensor,type:2Ah,offset:00h-01h,all:2 */
    DMS_DECLARE_SEN_TYPE_START(0x2A)
        {0x00, 0x00, "Session Activated. "},
        {0x01, 0x00, "Session Deactivated. "},
DMS_DECLARE_SEN_TYPE_END;

    /* Version  Cha nge Sensor,type:2B,offset:00h-07h,all:8 */
...
struct tag_dms_sensor_type g_dms_sensor_type[] = {

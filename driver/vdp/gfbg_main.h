...
#define GFBG_BIT_OFFSET_16 16u
#define GFBG_BIT_OFFSET_32 32u
#define GFBG_BIT_OFFSET_48 48u
#define GFBG_BIT_OFFSET_64 64u
#define GFBG_ADDR_EXTRACT_32 0xffffffff
#define GFBG_ADDR_EXTRACT_16 0xffff

#define GFBG_4BYTE_PER_PIXL 4u
#define GFBG_FB_INIT_VAL 0x0

#define gfbg_min(m, n) (((m) > (n)) ? (n) : (m))
#define gfbg_max(m, n) (((m) > (n)) ? (m) : (n))
...
#ifdef GFBG_MAX_LAYER_CLUT_G3_SUPPORT_4K
#define GFBG_MAX_LAYER_WIDTH_CLUT_G3 3840
#define GFBG_MAX_LAYER_HEIGTH_CLUT_G3 2160
#else
#define GFBG_MAX_LAYER_WIDTH_CLUT_G3 720
#define GFBG_MAX_LAYER_HEIGTH_CLUT_G3 576
#endif

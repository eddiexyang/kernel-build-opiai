...
#define MIPI_TX_REGS_ADDR   0x0400200000
#define MIPI_TX_REGS_SIZE   0x200000
...
#define MIPI_TX_REF_CLK             48

#define MIPI_TX_CRG_DELAY_LONG      5
#define MIPI_TX_CRG_DELAY_SHORT     3

/* crg */
#define MEDIA_SUBCTRL_REG             0x400130000
#define MEDIA_SUBCTRL_SIZE            0x10000U
#define SC_MIPI_RESET_REQ             0x0A90
#define SC_MIPI_RESET_DREQ            0x0A94
#define SC_MIPI_RESET_ST              0x5A90
#define SC_MIPI_CLK_SEL               0x0188
#define SC_MIPI_ICG_EN                0x0700
#define SC_MIPI_ICG_DIS               0x0704
#define SC_MIPI_ICG_ST                0x5700
#define SC_PLL_LOCK_STATUS            0xC100
...
#define DATA0_TPRE_DELAY_VALUE 0x5 // 0x9
#define DATA1_TPRE_DELAY_VALUE 0x5 // 0x9
#define DATA2_TPRE_DELAY_VALUE 0x5 // 0x9
#define DATA3_TPRE_DELAY_VALUE 0x5 // 0x9

#define CLK_POST_DELAY_VALUE   0x0
#define CLK_TLPX_VALUE         0x3 // 0x6
#define CLK_TCLK_PREPARE_VALUE 0x3 // 0x5
#define CLK_TCLK_ZERO_VALUE    0xb // 0x13
#define CLK_TCLK_TRAIL_VALUE   0x3 // 0x6

#define DATA0_TLPX_VALUE        0x3 // 0x6
#define DATA0_THS_PREPARE_VALUE 0x3 // 0x5
#define DATA0_THS_ZERO_VALUE    0x5 // 0x9
#define DATA0_THS_TRAIL_VALUE   0x3 // 0x6

#define DATA1_TLPX_VALUE        0x3 // 0x6
#define DATA1_THS_PREPARE_VALUE 0x3 // 0x5
#define DATA1_THS_ZERO_VALUE    0x5 // 0x9
#define DATA1_THS_TRAIL_VALUE   0x3 // 0x6

#define DATA2_TLPX_VALUE        0x3 // 0x6
#define DATA2_THS_PREPARE_VALUE 0x3 // 0x5
#define DATA2_THS_ZERO_VALUE    0x5 // 0x9
#define DATA2_THS_TRAIL_VALUE   0x3 // 0x6

#define DATA3_TLPX_VALUE        0x3 // 0x6
#define DATA3_THS_PREPARE_VALUE 0x3 // 0x5
#define DATA3_THS_ZERO_VALUE    0x5 // 0x9
#define DATA3_THS_TRAIL_VALUE   0x3 // 0x6

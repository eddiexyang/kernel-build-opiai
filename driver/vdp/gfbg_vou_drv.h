 ...
 * Description: gfbg drv operation
 */
#ifndef GFBG_DRV_H
#define GFBG_DRV_H
#include "gfbg.h"
...
#define gfbg_debug(fmt, ...)                                                         \
    VDP_DEBUG_TRACE("[ascend_vdp_hifb][DEBUG][%s:%d]:" fmt, __FUNCTION__, __LINE__, ##__VA_ARGS__) \

#define gfbg_fatal(fmt, ...)  \
    VDP_EMERG_TRACE("[ascend_vdp_hifb][EMERG][%s:%d]:" fmt, __FUNCTION__, __LINE__, ##__VA_ARGS__) \

#define gfbg_error(fmt, ...)  \
    VDP_ERR_TRACE("[ascend_vdp_hifb][ERROR][%s:%d]:" fmt, __FUNCTION__, __LINE__, ##__VA_ARGS__) \

#define gfbg_warning(fmt, ...) \
    VDP_WARN_TRACE("[ascend_vdp_hifb][WARN][%s:%d]:" fmt, __FUNCTION__, __LINE__, ##__VA_ARGS__) \

#define gfbg_info(fmt, ...)   \
    VDP_INFO_TRACE("[ascend_vdp_hifb][INFO][%s:%d]:" fmt, __FUNCTION__, __LINE__, ##__VA_ARGS__) \

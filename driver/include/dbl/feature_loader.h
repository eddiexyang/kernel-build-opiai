...
/*
 * Kernel 6.x removed public access to module->syms and struct kernel_symbol
 * internals. The feature auto-init/uninit mechanism that walks exported symbols
 * cannot work on 6.x. Provide stub implementations.
 */
#if LINUX_VERSION_CODE >= KERNEL_VERSION(6, 0, 0)
#define ASCEND_FEATURE_LOADER_STUB
#endif
...
#ifdef ASCEND_FEATURE_LOADER_STUB

/* Stub implementations for kernel 6.x+ */
static inline int module_feature_auto_init(void) { return 0; }
static inline void module_feature_auto_uninit(void) {}
static inline int module_feature_auto_init_dev(u32 devid) { return 0; }
static inline void module_feature_auto_uninit_dev(u32 devid) {}
static inline int module_feature_auto_init_task(int pid) { return 0; }
static inline void module_feature_auto_uninit_task(int pid) {}

#else /* !ASCEND_FEATURE_LOADER_STUB -- original implementation for < 6.0 */
...
#endif /* !ASCEND_FEATURE_LOADER_STUB */

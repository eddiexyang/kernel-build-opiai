 ...
 * For compatibility, keep the old file, new code please do not use.
 * Use bbox_pub.h instead.
 */
#ifndef BBOX_PUB_CLOUD_H
#define BBOX_PUB_CLOUD_H
...
enum EXCH_SOURCE {
    ...
    REBOOT_REASON_LABEL4 = 0x60,            /* label4: reserve */
...
typedef struct bbox_exception_info {
    ...
    u8 e_exce_type;                         // the type of happen exception
    ...
    u8 e_desc[BBOX_EXCEPTIONDESC_MAXLEN];   // the description of happen excption
 ...
 */
s32 bbox_register_module_ops(u8 core_id, const struct bbox_module_ops *ops,

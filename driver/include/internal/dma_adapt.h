...
#define DEVDRV_DMA_DES_PA_LOC_PA 0 /* The descriptor ‘s address is physical address */
#define DEVDRV_DMA_DES_PA_LOC_VA 1 /* The descriptor ‘s address is virtual address */
#define DEVDRV_DMA_DES_AT_LOC_PA 0 /* if PA_LOC is 0, AT_LOC must be 0 */
#define DEVDRV_DMA_DES_AT_LOC_VA 2 /* if PA_LOC is 1, AT_LOC must be 2 */

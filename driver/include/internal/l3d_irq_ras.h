...
#ifndef L3D_IRQ_RAS_H
#define L3D_IRQ_RAS_H

#include "drvfault_user_common.h"
#include "soc_misc_safety_conf.h"

/*
 * l3d_irq_ras_init - Initialize the "irq_ras" fault type of the l3d module.
 *
 * This interface is used to register the interrupt of ras fault to faultmng module.
 */
int l3d_irq_ras_init(void);

/*
 * l3d_irq_ras_uninit - Uninitialize the "irq_ras" fault type of the l3d module.
 *
 * This interface is used to unregister the interrupt of ras fault to faultmng module.
 */
void l3d_irq_ras_uninit(void);

 /*
 * l3d_irq_ras_handler - Reports ras fault events of l3d based on the safety status.

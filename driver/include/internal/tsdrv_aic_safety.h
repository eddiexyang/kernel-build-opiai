...
#ifndef TSDRV_AIC_SAFETY_H
#define TSDRV_AIC_SAFETY_H
 ...
 */
int tsdrv_aic_safety_handler(struct safety_fault_info *fault_info,
    unsigned int *event_num, struct safety_event **event_list);


#else
static inline int tsdrv_register_aic_safety_irq(u32 devid)
{
    return 0;
}

static inline void tsdrv_unregister_aic_safety_irq(u32 devid)
{
}
#endif

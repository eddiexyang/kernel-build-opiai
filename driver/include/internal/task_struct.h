...
typedef struct tag_ts_create_stream {
    ...
    uint8_t stream_attr;
    uint8_t group_id;
    uint8_t reserved[1];  // runtime: the size is
} ts_create_stream_t;
...
// 51 and Milan share this structure. 51 supports only 24 bytes and Milan supports 40 bytes

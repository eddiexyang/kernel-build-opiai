...
/*
 * l3t_safety_init - Initialize the safety fault type of the l3t module.
 *
 * This interface is used to register the interrupt of safety fault to faultmng module.
 */
int l3t_safety_init(void);

/*
 * l3t_safety_uninit - Uninitialize the safety fault type of the l3t module.
 *
 * This interface is used to unregister the interrupt of safety fault to faultmng module.
 */
void l3t_safety_uninit(void);

/*
 * l3t_safety_handler - Reports safety fault events of l3t based on the safety status.

...
/* Die id */
#define DIE_ID_ADDR 0x8006E200UL
#define DIE_ID_NUM 5
#define SOC_CHIP_OFFSET 0x8000000000UL
#define SOC_DIE_OFFSET 0x0UL

/* Chip info */
#define SOC_CHIP_INFO_REG_BASE 0x8000F000
#define SOC_CHIP_INFO_REG_OFFSET 0xFF8
#define SOC_CHIP_INFO_MAP_SIZE 0x1000

/* PCIe reg info */
#define PCIE_RAS_APB_SLAVE_BASE_ADDR 0xA2800000ULL

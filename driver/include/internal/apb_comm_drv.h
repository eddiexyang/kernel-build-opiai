...
#define DEVDRV_PLATFORM_TYPE_MASK 0x3
#define DEVDRV_PLTFORM_TYPE_SHIFT_16 16
#define DEVDRV_PLTFORM_TYPE_MASK_8_BIT 0xff
#define DEVDRV_PLTFORM_TYPE_MASK_16_BIT 0xffff
#define DEVDRV_TX_ATU_REG_SHIFT_32 32

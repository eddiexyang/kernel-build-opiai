...
/*
 * lpm_get_* — LPM hardware info queries.
 * Normally exported by lpm/drv_lpm_devmng, but that module does not
 * implement them for ascend310Brc. Provide inline stubs returning -ENOSYS;
 * callers in dms already handle failure gracefully.
 */

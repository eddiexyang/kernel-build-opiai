...
#define DMA_CTRL0_CHAN_EN_MASK (0x1U << DMA_CTRL0_CHAN_EN_OFFSET)
#define DMA_CTRL0_ERR_ABORT_EN_OFFSET 28
#define DMA_CTRL0_ERR_ABORT_EN_MASK (0xfU << DMA_CTRL0_ERR_ABORT_EN_OFFSET)
#define DMA_CTRL0_PAUSE_OFFSET 4
#define DMA_CTRL0_PAUSE_MASK (0x1U << DMA_CTRL0_PAUSE_OFFSET)
#define DMA_CTRL0_ARB_WAIGHT_OFFSET 8
#define DMA_CTRL0_ARB_WAIGHT_MASK (0xffU << DMA_CTRL0_ARB_WAIGHT_OFFSET)
#define DMA_CTRL0_CQSQ_DIR_OFFSET 26 /* bit26 cq side, bit27 sq side */
#define DMA_CTRL0_CQSQ_DIR_MASK (0x3U << DMA_CTRL0_CQSQ_DIR_OFFSET)

#define DMA_CTRL1_QUE_RESET_OFFSET 0
#define DMA_CTRL1_QUE_RESET_MASK (0x1U << DMA_CTRL1_QUE_RESET_OFFSET)

#define DMA_CTRL1_VA_CQ_SQ_ENABLE_MASK 0x604
#define DMA_CTRL1_VA_ENABLE_OFFSET 2
#define DMA_CTRL1_VA_ENABLE_MASK (0x1U << DMA_CTRL1_VA_ENABLE_OFFSET)

#define DMA_CTRL2_PF_NUM_OFFSET 0
#define DMA_CTRL2_PF_NUM_MASK (0x1fU << DMA_CTRL2_PF_NUM_OFFSET)

#define DMA_CTRL2_VF_NUM_OFFSET 16
#define DMA_CTRL2_VF_NUM_MASK (0xffU << DMA_CTRL2_VF_NUM_OFFSET)

#define DEVDRV_DMA_MSI_MAX_VECTORS 32

#define DEVDRV_DMA_CHAN_NUM 48
#define DMA_DONE_IRQ_NUM 30
#define DMA_DONE_IRQ_BASE 0
#define DMA_ERR_IRQ_NUM 1
#define DMA_ERR_IRQ_BASE 31

#define DEVDRV_DMA_QUEUE_ERR_STS 0x48 /* DMA_QUEUE_ERR_INT_STS */
...
#define DEVDRV_DMA_CHAN_ERR_MASK 0x4c

#define HOST_VF_DMA_MASK 0x3FFC000000 /* channel 26~37 for host VF use, 25 for PF only */
#define DEV_VF_DMA_MASK  0x1FFE       /* channel 1~12 for device VF use, 0  for PF only */

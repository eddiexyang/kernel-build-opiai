...
#include "vitruvian_perisub_reg_offset.h"

#define SC_CHIP_INFO (SOC_VITRUVIAN_PERISUB_SYSCTRL_REG_REG + 0xFFF8)
#define SC_VER_NUM (SOC_VITRUVIAN_PERISUB_SYSCTRL_REG_REG + 0xFFFC)

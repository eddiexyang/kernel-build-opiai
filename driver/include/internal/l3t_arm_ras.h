...
#ifndef L3T_ARM_RAS_H
#define L3T_ARM_RAS_H
...
/*
 * l3t_arm_ras_init - Initialize the "arm ras" fault type of the l3t module.
 *
...
/*
 * l3t_arm_ras_uninit - Uninitialize the "arm ras" fault type of the l3t module.
 *
...
/*
 * l3t_arm_ras_fpdc_handler - Reports arm ras fault events based on the notify data.
...
/*
 * l3t_arm_ras_irq_handler - Reports MBECC of SBECC events of l3t based on the safety status.

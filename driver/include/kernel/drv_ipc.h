...
#define IPCDRV_RPROC_MSG_LENGTH 24
#define IPCDRV_MSG_LENGTH 92
#define ICM_MSG_DATA_LENGTH 86

typedef enum {
    HISI_RPROC_RX_TS_MBX8, /* CLOUD_V2 */
    HISI_RPROC_RX_TS_MBX9,
    HISI_RPROC_RX_TS_MBX10,
    HISI_RPROC_RX_TS_MBX11,
    HISI_RPROC_TX_TS_MBX2,
    HISI_RPROC_TX_TS_MBX3,
    HISI_RPROC_TX_TS_MBX4,
    HISI_RPROC_TX_TS_MBX5,
    HISI_RPROC_RX_IMU_MBX20,
    HISI_RPROC_RX_IMU_MBX21,
    HISI_RPROC_RX_IMU_MBX22,
    HISI_RPROC_RX_IMU_MBX23,
    HISI_RPROC_TX_IMU_MBX28,
    HISI_RPROC_TX_IMU_MBX29,
    HISI_RPROC_MAX,
    HISI_RPROC_RX_IMU_MBX0, /* CLOUD should delete all CLOUD's channel after drv_mng adapted for CLOUD_V2 */
    HISI_RPROC_RX_IMU_MBX1,
    HISI_RPROC_RX_TS_MBX2,
    HISI_RPROC_TX_TS_MBX17,
    HISI_RPROC_TX_IMU_MBX24,
    HISI_RPROC_TX_IMU_MBX25,
    HISI_RPROC_RX_IMU_MBX3 /* CLOUD */
} rproc_id_t;

#elif defined(CFG_SOC_PLATFORM_CLOUD)
#define IPCDRV_RPROC_MSG_LENGTH 8
#define IPCDRV_MSG_LENGTH 28
#define ICM_MSG_DATA_LENGTH 22
...
#elif defined(CFG_SOC_PLATFORM_MINIV2) && !defined(CFG_SOC_PLATFORM_MDC_V51) && !defined(CFG_SOC_PLATFORM_HELPER) && \
    !defined(CFG_SOC_PLATFORM_MINIV2_MDC) && !defined(CFG_FEATURE_RC_MODE) && !defined(AOS_LLVM_BUILD) && \
    !defined(CFG_SOC_PLATFORM_MINIV3)
#define IPCDRV_RPROC_MSG_LENGTH 8
#define IPCDRV_MSG_LENGTH 28
#define ICM_MSG_DATA_LENGTH 22
...
typedef enum {
    ...
    HISI_RPROC_MAX
       ...
       defined(CFG_SOC_PLATFORM_MDC_V51_LITE)) && !defined(CFG_SOC_PLATFORM_MINIV3)
#define IPCDRV_RPROC_MSG_LENGTH 8
#define IPCDRV_MSG_LENGTH 28
#define ICM_MSG_DATA_LENGTH 22
...
typedef enum {
    HISI_RPROC_RX_LP_ACPU0,     /* ACPU0 */
    HISI_RPROC_RX_LP_ACPU1,     /* ACPU1 */
    HISI_RPROC_RX_LP_ACPU2,     /* ACPU2 */
    HISI_RPROC_RX_LP_ACPU3,     /* ACPU3 */

    HISI_RPROC_TX_LP_ACPU0,
    HISI_RPROC_TX_LP_ACPU1,
    HISI_RPROC_TX_LP_ACPU2,
    HISI_RPROC_TX_LP_ACPU3,

    HISI_RPROC_RX_TS_ACPU0,
    HISI_RPROC_RX_TS_ACPU1,
    HISI_RPROC_RX_TS_ACPU2,
    HISI_RPROC_RX_TS_ACPU3,
    HISI_RPROC_TX_TS_ACPU0,
    HISI_RPROC_TX_TS_ACPU1,
    HISI_RPROC_TX_TS_ACPU2,
    HISI_RPROC_TX_TS_ACPU3,
    HISI_RPROC_MAX,

    HISI_RPROC_TX_TS,
    HISI_RPROC_RX_TS_MBX4,
    HISI_RPROC_RX_TS_MBX6
} rproc_id_t;
#else
#define IPCDRV_RPROC_MSG_LENGTH 8
#define IPCDRV_MSG_LENGTH 28
...
#define RPROC_ASYNC_SEND(ipc_id, rproc_id, msg, len) \
    rproc_xfer_async(ipc_id, rproc_id, msg, len)
#define RPROC_MONITOR_REGISTER(ipc_id, rproc_id, nb) \
    rproc_rx_register(ipc_id, rproc_id, nb)
#define RPROC_MONITOR_UNREGISTER(ipc_id, rproc_id, nb) \
    rproc_rx_unregister(ipc_id, rproc_id, nb)
#define RPROC_PUT(ipc_id, rproc_id) hs_rproc_put(ipc_id, rproc_id)
#define RPROC_FLUSH_TX(ipc_id, rproc_id)    rproc_flush_tx(ipc_id, rproc_id)
#endif

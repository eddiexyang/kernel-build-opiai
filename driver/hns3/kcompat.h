...
static inline struct phy_device *_kc_mdiobus_get_phy(struct mii_bus *bus, int addr)
{
...
#define timer_setup(timer, callback, flags) \
    __setup_timer((timer), (TIMER_FUNC_TYPE)(callback), (TIMER_DATA_TYPE)(timer), (flags))
...
#define __unsigned_mul_overflow(a, b, d)                                          \
    ({                                                                            \
        ...
        (void)(&__a == __d);                                                      \
        *__d = __a * __b;                                                         \
        __builtin_constant_p(__b) ? __b > 0 && __a > type_max(typeof(__a)) / __b  \
...
#define check_add_overflow(a, b, d) \
    __builtin_choose_expr(is_signed_type(typeof(a)), __signed_add_overflow(a, b, d), __unsigned_add_overflow(a, b, d))

#define check_sub_overflow(a, b, d) \
    __builtin_choose_expr(is_signed_type(typeof(a)), __signed_sub_overflow(a, b, d), __unsigned_sub_overflow(a, b, d))

#define check_mul_overflow(a, b, d) \
    __builtin_choose_expr(is_signed_type(typeof(a)), __signed_mul_overflow(a, b, d), __unsigned_mul_overflow(a, b, d))

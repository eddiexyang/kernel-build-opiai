...
static hdmi_ctrl_info g_ctrl_info[(td_s32)HDMI_ID_MAX];

static hdmi_ctrl_info *ctrl_info_ptr_get(hdmi_device_id hdmi)
{
    if ((td_s32)hdmi < (td_s32)HDMI_ID_MAX) {
...
static td_void ctrl_audio_i2s_enable_set(td_u32 id, td_bool enable)
{
    ...
    hdmi_reg_aud_i2s_en_set(id, (td_u8)audio_i2s_enable);
    return;
}
...
{
    hdmi_reg_aud_spdif_en_set(id, (td_u8)spdif_enable);
    return;
}
...
{
    hdmi_reg_aud_in_en_set(id, (td_u8)audio_enable);
    return;
}
...
{
    hdmi_reg_acr_cts_hw_sw_sel_set(id, (td_u8)sw_cts);
    return;
}
...
{
    hdmi_reg_aud_layout_set(id, (td_u8)muti_layout);
    return;
}
...
{
    hdmi_reg_i2s_hbra_on_set(id, (td_u8)hbra_enable);
    return;
}
...
{
    hdmi_reg_i2s_1st_shift_set(id, (td_u8)i2s_ctrl->sck_shift_one);
    hdmi_reg_i2s_ws_polarity_set(id, (td_u8)i2s_ctrl->polarity_ws_msb_left);
    hdmi_reg_i2s_justify_set(id, (td_u8)i2s_ctrl->justify_ws_right);
    hdmi_reg_i2s_data_dir_set(id, (td_u8)i2s_ctrl->data_dir_msb_first);
    hdmi_reg_i2s_vbit_set(id, (td_u8)i2s_ctrl->vbit_compress);
    hdmi_reg_i2s_length_set(id, (td_u8)i2s_ctrl->in_bit_length);
    hdmi_reg_i2s_ch_swap_set(id, (td_u8)i2s_ctrl->channel_lr_swap);
...
static td_void ctrl_audio_i2s_status_set(td_u32 id, const ctrl_i2s_status *i2s_status)
{
    ...
    hdmi_reg_chst_byte0_bset(id, (td_u8)i2s_status->compress);
    hdmi_reg_chst_byte3_fs_set(id, (td_u8)i2s_status->samp_rate);
    hdmi_reg_chst_byte3_clock_accuracy_set(id, (td_u8)i2s_status->clk_accuracy);
    hdmi_reg_chst_byte4_org_fs_set(id, (td_u8)i2s_status->org_rate);
    hdmi_reg_chst_byte4_length_set(id, (td_u8)i2s_status->out_bit_length);
...
{
    hdmi_reg_aud_fifo_test_set(id, (td_u8)fifo_ctrl->test);
    hdmi_reg_aud_fifo_hbr_mask_set(id, (td_u8)fifo_ctrl->hbra_mask);
    return;
}

static td_void ctrl_audio_reset(hdmi_device_id id)
{
    hdmi_reg_tx_afifo_srst_req_set((td_u32)id, TD_TRUE);
    hdmi_reg_tx_acr_srst_req_set((td_u32)id, TD_TRUE);
    hdmi_reg_tx_aud_srst_req_set((td_u32)id, TD_TRUE);
    hdmi_reg_tx_afifo_srst_req_set((td_u32)id, TD_FALSE);
    hdmi_reg_tx_acr_srst_req_set((td_u32)id, TD_FALSE);
    hdmi_reg_tx_aud_srst_req_set((td_u32)id, TD_FALSE);
...
static td_void ctrl_avmute_set(td_u32 id, const hdmi_avmute_cfg *avmute_cfg)
{
    ...
    hdmi_reg_cp_set_avmute_set(id, (td_u8)avmute_cfg->mute_set);
    hdmi_reg_cp_clr_avmute_set(id, (td_u8)avmute_cfg->mute_clr);
    /* set GCP avmute funtcion enable, sent loop */
    hdmi_reg_cea_cp_rpt_cnt_set(id, (td_u8)avmute_cfg->rpt_cnt);
    hdmi_reg_cea_cp_rpt_en_set(id, (td_u8)avmute_cfg->mute_pkg_en);
    hdmi_reg_cea_cp_en_set(id, (td_u8)avmute_cfg->mute_pkg_en);
...
{
    hdmi_reg_tmds_pack_mode_set(id, (td_u8)deep_color_bit);
    hdmi_reg_dc_pkt_en_set(id, (td_u8)enable_gcp);
    return;
}
...
static td_s32 ctrl_video_path_polarity_set(td_u32 id, const hdmi_sync_pol_type *out_sync_pol)
{
    ...
    hdmi_reg_inver_sync_set(id, (td_u8)sync_pol_cfg);
...
{
    hdmi_reg_dither_rnd_bypass_set(id, enable == TD_FALSE);
    hdmi_reg_dither_mode_set(id, (td_u8)dither_mode);
    return;
}
...
static td_void ctrl_video_color_rgb_set(td_u32 id, td_bool rgb_in, td_bool rgb_out)
{
    ...
    hdmi_reg_csc_mode_set(id, (td_u8)reg_value);
...
{
    hdmi_reg_csc_en_set(id, (td_u8)csc_enable);
    return;
}
...
{
    hdmi_reg_demux_420_en_set(id, (td_u8)enable);
    hdmi_reg_pxl_div_en_set(id, (td_u8)enable);
    return;
}

static td_void ctrl_video_color_dwsm_vert_set(td_u32 id, td_bool dwsm_vert)
{
    hdmi_reg_dwsm_vert_bypass_set(id, dwsm_vert == TD_FALSE);
    hdmi_reg_dwsm_vert_en_set(id, (td_u8)dwsm_vert);
    return;
}

static td_void ctrl_video_color_dwsm_hori_set(td_u32 id, td_bool dwsm_hori)
{
    hdmi_reg_hori_filter_en_set(id, (td_u8)dwsm_hori);
    hdmi_reg_dwsm_hori_en_set(id, (td_u8)dwsm_hori);
    return;
}
    ...
    hdmi_hal_colorimetry in_colormetry, hdmi_hal_colorimetry out_colormetry)
{
    ...
    hdmi_reg_csc_mode_set(id, (td_u8)csc_mode);
...
static td_void videopath_colorspace_param_get(hdmi_colorspace in, hdmi_colorspace out, ctrl_colorspace_en *en)
{
    if (in == HDMI_COLORSPACE_YCBCR444) {
        ...
        hdmi_warn("un-expected in_color_space=%d\n", (td_s32)in);
    }
    ...
    hdmi_colorspace in_color_space, hdmi_colorspace out_color_space)
{
    ...
    hdmi_debug("ctrl csc set:\n"
               "\tin_rgb=%u, out_rgb=%u, csc_enable=%u \n"
               "\ty422_enable=%u, dwsm_hori_enable=%u \n"
               "\ty420_enable=%u, dwsm_vert_enable=%u \n",
        (td_u32)colorspace_en.in_rgb,
        (td_u32)colorspace_en.out_rgb,
        (td_u32)colorspace_en.csc_enable,
        (td_u32)colorspace_en.y422_enable,
        (td_u32)colorspace_en.dwsm_hori_enable,
        (td_u32)colorspace_en.y420_enable,
        (td_u32)colorspace_en.dwsm_vert_enable);
...
{
    hdmi_reg_cea_vsif_rpt_en_set(id, (td_u8)enable);
    hdmi_reg_cea_vsif_en_set(id, (td_u8)enable);
    return TD_SUCCESS;
}
...
{
    hdmi_reg_cea_avi_rpt_en_set(id, (td_u8)enable);
    hdmi_reg_cea_avi_en_set(id, (td_u8)enable);
...
static td_s32 ctrl_tmds_mode_set(td_u32 id, hdmi_tmds_mode tmds_mode)
{
    switch (tmds_mode) {
        ...
        case HDMI_TMDS_MODE_HDMI_2_0:
            ...
            break;
        default:
            hdmi_warn("un-known tmds mode:%d\n", (td_s32)tmds_mode);
            return TD_FAILURE;
    }
...
static td_s32 ctrl_tmds_mode_get(td_u32 id, hdmi_tmds_mode *tmds_mode)
{
    ...
    if (hdmi_mode == TD_FALSE) {
        *tmds_mode = HDMI_TMDS_MODE_DVI;
    } else if (hdmi_mode && (hdmi2x_enable == TD_FALSE)) {
...
static td_s32 ctrl_timming_decect_get(td_u32 id, ctrl_timming_detect *timing)
{
    ...
    hdmi_reg_sync_polarity_force_set(id, (td_u8)timing->sync_sw_enable);
...
static td_void ctrl_video_mute_set(td_u32 id, td_bool enable)
{
    ...
    hdmi_reg_solid_pattern_cr_set(id, (td_u8)data_value);

    data_value = (in_color_space == HDMI_COLORSPACE_RGB) ? CTRL_BLACK_DATA_RGB_G : CTRL_BLACK_DATA_YUV_Y;
    hdmi_reg_solid_pattern_y_set(id, (td_u8)data_value);

    data_value = (in_color_space == HDMI_COLORSPACE_RGB) ? CTRL_BLACK_DATA_RGB_B : CTRL_BLACK_DATA_YUV_CB;
    hdmi_reg_solid_pattern_cb_set(id, (td_u8)data_value);

    hdmi_reg_video_blank_en_set(id, (td_u8)enable);
    hdmi_reg_solid_pattern_en_set(id, (td_u8)enable);
...
{
    /* repeat enable */
    hdmi_reg_cea_aud_rpt_en_set(id, (td_u8)enable);
    /* info_frame enable */
    hdmi_reg_cea_aud_en_set(id, (td_u8)enable);
    return TD_SUCCESS;
}
...
{
    hdmi_reg_cea_gamut_rpt_en_set(id, (td_u8)enable);
    hdmi_reg_cea_gamut_en_set(id, (td_u8)enable);
    return TD_SUCCESS;
}
...
static td_void ctrl_hpd_intr_enable(td_u32 id, td_bool enable)
{
    ...
    hdmi_reg_aon_intr_mask0_set(id, (td_u8)enable);
    return;
}
...
{
    hdmi_reg_null_pkt_en_set(id, (td_u8)enable);
    return TD_SUCCESS;
}
...
td_s32 hal_hdmi_ctrl_init(hdmi_device_id hdmi, const hdmi_hal_init *hal_init)
{
    ...
    if (ctrl_info->init == TD_FALSE) {
        ret += hdmi_reg_crg_init((td_u32)hdmi);
        hdmi_if_null_return(hal_init->base_addr, OT_ERR_HDMI_NULL_PTR);
        ret += hdmi_reg_aon_regs_init((td_u32)hdmi, hal_init->base_addr);
        ret += hdmi_reg_audio_path_regs_init((td_u32)hdmi, hal_init->base_addr);
        ret += hdmi_reg_tx_ctrl_regs_init((td_u32)hdmi, hal_init->base_addr);
        ret += hdmi_reg_tx_hdmi_regs_init((td_u32)hdmi, hal_init->base_addr);
        ret += hdmi_reg_video_path_regs_init((td_u32)hdmi, hal_init->base_addr);

        // hdmi subctr reset
        hdmi_reg_top_reset_set((td_u32)hdmi, TD_TRUE);
        hdmi_reg_ctrl_srst_req_set((td_u32)hdmi, TD_TRUE);
        hdmi_reg_subctrl_clk_set((td_u32)hdmi);

        drv_hdmi_prod_crg_gate_set((td_u32)hdmi, TD_TRUE);
        ctrl_info->event_callback = hal_init->event_callback;
        ctrl_info->event_data = hal_init->event_data;
        ctrl_info->init       = TD_TRUE;
        ctrl_info->hdmi_id    = (td_u32)hdmi;
        ...
        ctrl_hpd_intr_enable((td_u32)hdmi, TD_TRUE);
    }
...
td_s32 hal_hdmi_ctrl_deinit(hdmi_device_id hdmi)
{
    ...
    ctrl_hpd_intr_enable((td_u32)hdmi, TD_FALSE);
    ret = hal_hdmi_mach_stop(ctrl_info->mach_id);
    ret += hal_hdmi_mach_unregister(ctrl_info->mach_id);
    ret += hdmi_reg_audio_path_regs_deinit((td_u32)hdmi);
    ret += hdmi_reg_aon_regs_deinit((td_u32)hdmi);
    ret += hdmi_reg_tx_ctrl_regs_deinit((td_u32)hdmi);
    ret += hdmi_reg_tx_hdmi_regs_deinit((td_u32)hdmi);
    ret += hdmi_reg_video_path_regs_deinit((td_u32)hdmi);
...
td_s32 hal_hdmi_ctrl_avmute_get(hdmi_device_id hdmi, td_bool *enable)
{
    ...
    return ctrl_avmute_get((td_u32)hdmi, enable);
}
...
td_s32 hal_hdmi_ctrl_csc_set(hdmi_device_id hdmi, const hdmi_video_config *video_cfg)
{
    ...
    ctrl_video_path_colorimetry_set((td_u32)hdmi, video_cfg->conv_std, video_cfg->conv_std);
    ctrl_video_path_quantization_set((td_u32)hdmi, video_cfg->out_csc_quantization, video_cfg->out_csc_quantization);
    (void)ctrl_video_path_color_space_set((td_u32)hdmi, video_cfg->in_color_space, video_cfg->out_color_space);
...
td_s32 hal_hdmi_ctrl_video_path_set(hdmi_device_id hdmi, hdmi_video_path *video_path)
{
    ...
    /* dither */
    ctrl_video_dither_set((td_u32)hdmi, video_path);
    ret = ctrl_video_path_polarity_set((td_u32)hdmi, &video_path->out_hv_sync_pol);
    ctrl_video_path_colorimetry_set((td_u32)hdmi, video_path->in_colormetry, video_path->out_colormetry);
    ctrl_video_path_quantization_set((td_u32)hdmi, video_path->in_quantization, video_path->out_quantization);
    (void)ctrl_video_path_color_space_set((td_u32)hdmi, video_path->in_color_space, video_path->out_color_space);
...
td_s32 hal_hdmi_ctrl_tmds_mode_set(hdmi_device_id hdmi, hdmi_tmds_mode tmds_mode)
{
    ...
    return ctrl_tmds_mode_set((td_u32)hdmi, tmds_mode);
}
...
td_s32 hal_hdmi_ctrl_infoframe_en_set(hdmi_device_id hdmi, hdmi_infoframe_id infoframe_id, td_bool enable)
{
    ...
    switch (infoframe_id) {
        case HDMI_INFOFRAME_TYPE_NULL:
            ret = ctrl_null_packet_set((td_u32)hdmi, enable);
            break;
#ifdef HDMI_VENDOR_SUPPORT
        case HDMI_INFOFRAME_TYPE_VENDOR:
            ret = ctrl_vendor_infoframe_en_set((td_u32)hdmi, enable);
            break;
#endif
        case HDMI_INFOFRAME_TYPE_AVI:
            ret = ctrl_avi_infoframe_en_set((td_u32)hdmi, enable);
            break;
        case HDMI_INFOFRAME_TYPE_AUDIO:
            ret = ctrl_audio_infoframe_en_set((td_u32)hdmi, enable);
            break;
        case HDMI_INFOFRAME_TYPE_GBD:
            ret = ctrl_gbd_infoframe_en_set((td_u32)hdmi, enable);
            break;
        default:
            hdmi_warn("un-support infoframe type:%d!\n", (td_s32)infoframe_id);
            ret = TD_FAILURE;
            break;
    }
...
#ifdef HDMI_VENDOR_SUPPORT
        case HDMI_INFOFRAME_TYPE_VENDOR:
            ret = ctrl_vendor_infoframe_data_set((td_u32)hdmi, data);
            break;
#endif
        case HDMI_INFOFRAME_TYPE_AVI:
            ret = ctrl_avi_infoframe_data_set((td_u32)hdmi, data);
            break;
        case HDMI_INFOFRAME_TYPE_AUDIO:
            ret = ctrl_audio_infoframe_data_set((td_u32)hdmi, data);
            break;
        default:
            hdmi_warn("un-support infoframe type:%d!\n", (td_s32)infoframe_id);
            ret = TD_FAILURE;
...
td_s32 hal_hdmi_ctrl_data_reset(hdmi_device_id hdmi, td_bool debug_mode, td_u32 delay_ms)
{
    ...
    hdmi_reg_tx_acr_srst_req_set((td_u32)hdmi, TD_TRUE);
    hdmi_reg_tx_afifo_srst_req_set((td_u32)hdmi, TD_TRUE);
    hdmi_reg_tx_aud_srst_req_set((td_u32)hdmi, TD_TRUE);
    hdmi_reg_tx_hdmi_srst_req_set((td_u32)hdmi, TD_TRUE);
    osal_udelay(CTRL_REAET_WAIT_TIME);
    hdmi_reg_tx_acr_srst_req_set((td_u32)hdmi, TD_FALSE);
    hdmi_reg_tx_afifo_srst_req_set((td_u32)hdmi, TD_FALSE);
    hdmi_reg_tx_aud_srst_req_set((td_u32)hdmi, TD_FALSE);
    /* TOP rst: will also pack_fifo_ctrl reg_fifo_manu_rst */
    hdmi_reg_tx_hdmi_srst_req_set((td_u32)hdmi, TD_FALSE);
...
td_s32 hal_hdmi_ctrl_video_mute_set(hdmi_device_id hdmi, td_bool enable)
{
    ...
    ctrl_video_mute_set((td_u32)hdmi, enable);
...
td_s32 hal_hdmi_ctrl_video_mute_get(hdmi_device_id hdmi, td_bool *enable)
{
    ...
    return ctrl_video_mute_get((td_u32)hdmi, enable);
}
...
td_s32 hal_hdmi_ctrl_audio_path_set(hdmi_device_id hdmi, const hdmi_audio_path *audio_path)
{
    ...
    ctrl_audio_path_enable_set((td_u32)hdmi, TD_FALSE);
    ctrl_audio_reset(hdmi);

    org_reg_rate_cfg = (td_u32)audio_path->sample_rate;
    /* I2S layout */
    if (audio_path->channel_num == HDMI_AUDIO_FORMAT_8CH) {
        ...
        hdmi_warn("error audio channel number:%d\n", (td_s32)audio_path->channel_num);
    }

    ctrl_audio_path_layout_set((td_u32)hdmi, muti_layout);

    /* i2s ctrl */
    i2s_ctrl.in_bit_length = ctrl_audio_bit_reg_get((td_u32)audio_path->sample_bit);
    ctrl_audio_i2s_ctrl_set((td_u32)hdmi, &i2s_ctrl);

    /* i2s status */
    i2s_status.clk_accuracy     = HDMI_AUDIO_CLK_ACCURACY_LEVEL2;
    i2s_status.samp_rate        = ctrl_i2s_rate_reg_get(org_reg_rate_cfg);
    i2s_status.org_rate         = ctrl_i2s_rate_org_reg_get((td_u32)audio_path->sample_rate);
    i2s_status.out_bit_length   = ctrl_audio_bit_reg_get((td_u32)audio_path->sample_bit);
    ctrl_audio_i2s_status_set((td_u32)hdmi, &i2s_status);

    fifo_ctrl.hbra_mask = HDMI_AUDIO_HBRA_MASK_NONE;
    ctrl_audio_fifo_ctrl_set((td_u32)hdmi, &fifo_ctrl);

    /* CTS & N value */
    ctrl_audio_path_cts_value_set((td_u32)hdmi, TD_FALSE);
    n_value = hal_hdmi_n_value_get((td_u32)audio_path->sample_rate, audio_path->pixel_clk);
    ctrl_audio_path_n_value_set((td_u32)hdmi, n_value);

    cts_value = hal_hdmi_cts_value_get((td_u32)audio_path->sample_rate, audio_path->pixel_clk);
    hdmi_debug("\n fs=%d,bit=%d,intf=%d,tmds=%u\n"
               "reference N=%u,real N=%u,reference cts=%u,real_cts=%u\n",
        (td_s32)audio_path->sample_rate,
        (td_s32)audio_path->sample_bit,
        (td_s32)audio_path->sound_intf,
        audio_path->pixel_clk,
        n_value,
        ctrl_audio_path_n_value_get((td_u32)hdmi),
        cts_value,
        ctrl_audio_path_cts_value_get((td_u32)hdmi));

    /* enable */
    ctrl_audio_i2s_enable_set((td_u32)hdmi, TD_TRUE);
    ctrl_audio_spdif_enable_set((td_u32)hdmi, spdif_enable);
    ctrl_audio_hbra_enable_set((td_u32)hdmi, hbra_enable); /* when spdif, it must false */
...
td_s32 hal_hdmi_ctrl_audio_path_get(hdmi_device_id hdmi, ctrl_audio_status *audio_stat)
{
    ...
    if (ctrl_audio_spdif_enable_get((td_u32)hdmi)) {
        audio_stat->sound_intf = HDMI_AUDIO_INTF_SPDIF;
    } else if (ctrl_audio_hbra_enable_get((td_u32)hdmi)) {
        audio_stat->sound_intf = HDMI_AUDIO_INTF_HBRA;
    } else if (ctrl_audio_i2s_enable_get((td_u32)hdmi)) {
        audio_stat->sound_intf = HDMI_AUDIO_INTF_I2S;
    } else {
        audio_stat->sound_intf = HDMI_AUDIO_INTF_BUTT;
    }

    audio_stat->enable_audio = ctrl_audio_path_enable_get((td_u32)hdmi);
    audio_stat->audio_mute   = ctrl_audio_mute_get((td_u32)hdmi);
    audio_stat->sample_bit   = ctrl_audio_bit_value_get((td_u32)hdmi, TD_FALSE);
    audio_stat->sample_rate  = ctrl_i2s_rate_value_get((td_u32)hdmi);
    audio_stat->channel_num  = ctrl_audio_path_layout_get((td_u32)hdmi) ? HDMI_AUDIO_FORMAT_8CH : HDMI_AUDIO_FORMAT_2CH;
    audio_stat->ref_cts      = hal_hdmi_cts_value_get((td_u32)audio_path->sample_rate, audio_path->pixel_clk);
    audio_stat->reg_cts      = ctrl_audio_path_cts_value_get((td_u32)hdmi);
    audio_stat->ref_n        = hal_hdmi_n_value_get((td_u32)audio_path->sample_rate, audio_path->pixel_clk);
    audio_stat->reg_n        = ctrl_audio_path_n_value_get((td_u32)hdmi);
...
td_void hal_hdmi_ctrl_video_path_get(hdmi_device_id hdmi, ctrl_video_status *video_stat)
{
    ...
    ret = ctrl_timming_decect_get((td_u32)hdmi, &video_stat->timing);
    ret += ctrl_video_path_polarity_get((td_u32)hdmi, &video_stat->out_hv_sync_pol);
    ctrl_video_path_color_space_get((td_u32)hdmi, &video_stat->in_color_space, &video_stat->out_color_space);
    ret += ctrl_video_path_dither_get((td_u32)hdmi, &enable_dither, &video_stat->dither_mode);
    ret += ctrl_video_path_colormetry_get((td_u32)hdmi, &video_stat->in_colormetry, &video_stat->out_colormetry);
    ret += ctrl_video_path_quantization_get((td_u32)hdmi, &video_stat->in_quantization, &video_stat->out_quantization);
    ret += ctrl_video_path_deep_clr_get((td_u32)hdmi, &enable_gcp, &video_stat->out_deep_color);
    video_stat->csc_enable = ctrl_video_color_csc_get((td_u32)hdmi);

    if (enable_gcp == TD_FALSE) {
    ...
    video_stat->y422_enable = ctrl_video_color_dwsm_hori_get((td_u32)hdmi);
    video_stat->y420_enable = ctrl_video_color_ycbcr420_get((td_u32)hdmi);
...
td_s32 hal_hdmi_ctrl_tmds_mode_get(hdmi_device_id hdmi, hdmi_tmds_mode *tmds_mode)
{
    ...
    return ctrl_tmds_mode_get((td_u32)hdmi, tmds_mode);
}
...
#ifdef HDMI_VENDOR_SUPPORT
        case HDMI_INFOFRAME_TYPE_VENDOR:
            ret = ctrl_vendor_infoframe_en_get((td_u32)hdmi, enable);
            break;
#endif
        case HDMI_INFOFRAME_TYPE_AVI:
            ret = ctrl_avi_infoframe_en_get((td_u32)hdmi, enable);
            break;
        case HDMI_INFOFRAME_TYPE_AUDIO:
            ret = ctrl_audio_infoframe_en_get((td_u32)hdmi, enable);
            break;
        case HDMI_INFOFRAME_TYPE_GBD:
            ret = ctrl_gbd_infoframe_en_get((td_u32)hdmi, enable);
            break;
        default:
            hdmi_warn("un-support infoframe type:%d!\n", (td_s32)infoframe_id);
            ret = TD_FAILURE;
...
#ifdef HDMI_VENDOR_SUPPORT
        case HDMI_INFOFRAME_TYPE_VENDOR:
            ret = ctrl_vendor_infoframe_data_get((td_u32)hdmi, data);
            break;
#endif
        case HDMI_INFOFRAME_TYPE_AVI:
            ret = ctrl_avi_infoframe_data_get((td_u32)hdmi, data);
            break;
        case HDMI_INFOFRAME_TYPE_AUDIO:
            ret = ctrl_audio_infoframe_data_get((td_u32)hdmi, data);
            break;
        case HDMI_INFOFRAME_TYPE_GBD:
            ret = ctrl_gbd_infoframe_data_get((td_u32)hdmi, data);
            break;
        default:
            hdmi_warn("un-support infoframe type:%d!\n", (td_s32)infoframe_id);
            ret = TD_FAILURE;
...
td_s32 hal_hdmi_ctrl_hpd_rsen_get(hdmi_device_id hdmi, hdmi_hpd_rsen *hpd_rsen)
{
    ...
    hpd_rsen->rsen_on = ctrl_rsen_get((td_u32)hdmi);
    hpd_rsen->hpd_on = ctrl_hpd_get((td_u32)hdmi);
...
td_void hal_hdmi_ctrl_dither_dbg_set(hdmi_device_id hdmi, hdmi_video_dither dither_mode)
{
    ...
    ctrl_video_path_dither_set((td_u32)hdmi, enable_dither, dither_mode);
...
{
    hdmi_ctrl_info *ctrl_info = ctrl_info_ptr_get((td_u32)hdmi);

    hdmi_if_null_return(stable, OT_ERR_HDMI_NULL_PTR);
    hdmi_if_null_return(ctrl_info, OT_ERR_HDMI_NULL_PTR);
    hdmi_if_false_return(ctrl_info->init, TD_FAILURE);

    *stable = hdmi_reg_pclk2tclk_stable_get((td_u32)hdmi) ? TD_TRUE : TD_FALSE;
    return TD_SUCCESS;
}

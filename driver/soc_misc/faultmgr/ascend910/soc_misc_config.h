...
#  error "This header can only include in ascend910"
#endif
...
#define SOC_MISC_SENSOR_MN_NUM 1
...
STATIC struct dms_node
    g_soc_misc_dev_node_table[SOC_MISC_DEVICE_NUM_MAX][SOC_MISC_SENSOR_ID_MAX][SOC_MISC_MAX_NODE_NUM] = {
        ...
        SOC_MISC_DEV_NODES(SOC_MISC_NODE_2),
        SOC_MISC_DEV_NODES(SOC_MISC_NODE_3),
    };
...
g_soc_misc_ring_sensor_table[SOC_MISC_DEVICE_NUM_MAX][SOC_MISC_MAX_NODE_NUM][SOC_MISC_SENSOR_RING_NUM] = {
    { /* dev_node 0 */
        ...
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_1, 0, DMS_SEN_TYPE_RAS_SENSOR, "SLLC", soc_misc_sllc_sensor_scan) },
    }, {
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_2, 0, DMS_SEN_TYPE_RAS_SENSOR, "SLLC", soc_misc_sllc_sensor_scan) },
    }, {
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_3, 0, DMS_SEN_TYPE_RAS_SENSOR, "SLLC", soc_misc_sllc_sensor_scan) },
    }
};
...
g_soc_misc_pcie_sensor_table[SOC_MISC_DEVICE_NUM_MAX][SOC_MISC_MAX_NODE_NUM][SOC_MISC_SENSOR_PCIE_NUM] = {
    { /* dev_node 0 */
        ...
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_2, 0, DMS_SEN_TYPE_RAS_SENSOR, "pcie_local", soc_misc_pcie_sensor_scan) },
    }, {
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_3, 0, DMS_SEN_TYPE_RAS_SENSOR, "pcie_local", soc_misc_pcie_sensor_scan) },
    }
};

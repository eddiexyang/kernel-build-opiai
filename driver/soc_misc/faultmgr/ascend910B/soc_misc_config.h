...
#define SOC_MISC_PCIE_DISP_NODES(_dev_id) { \
    SOC_MISC_PCIE_DISP_NODE(_dev_id, 0),      \
    SOC_MISC_PCIE_DISP_NODE(_dev_id, 1),      \
}
...
#define SOC_MISC_DEV_NODES(_dev_id) {    \
    ...
    SOC_MISC_RESV_NODES(_dev_id),      \
    SOC_MISC_RESV_NODES(_dev_id),      \
    SOC_MISC_PCIE_DISP_NODES(_dev_id), \
}
...
STATIC struct dms_sensor_object_cfg
g_soc_misc_pcie_disp_sensor_table[SOC_MISC_DEVICE_NUM_MAX][SOC_MISC_MAX_NODE_NUM][SOC_MISC_SENSOR_PCIE_NUM] = {
    { /* dev_node 0 */
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_0, 0, DMS_SEN_TYPE_RAS_SENSOR, "pcie_disp",
            soc_misc_pcie_disp_sensor_scan) },
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_0, 1, DMS_SEN_TYPE_RAS_SENSOR, "pcie_disp",
            soc_misc_pcie_disp_sensor_scan) },
    }, { /* dev_node 1 */
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_1, 0, DMS_SEN_TYPE_RAS_SENSOR, "pcie_disp",
            soc_misc_pcie_disp_sensor_scan) },
        { SOC_MISC_DMS_SENSOR(SOC_MISC_NODE_1, 1, DMS_SEN_TYPE_RAS_SENSOR, "pcie_disp",
            soc_misc_pcie_disp_sensor_scan) },
    },
};

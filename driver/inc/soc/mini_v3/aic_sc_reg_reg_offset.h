...
#define SOC_AIC_SC_REG_AXI_CLAMP_STATE_4_REG                (SOC_AIC_SC_REG_BASE + 0x5D0)
#define SOC_AIC_SC_REG_AXI_CLAMP_STATE_5_REG                (SOC_AIC_SC_REG_BASE + 0x5D4)
#define SOC_AIC_SC_REG_AXI_CLAMP_STATE_6_REG                (SOC_AIC_SC_REG_BASE + 0x5D8)
#define SOC_AIC_SC_REG_AXI_CLAMP_STATE_7_REG                (SOC_AIC_SC_REG_BASE + 0x5DC)
...
#define SOC_AIC_SC_REG_AIC_ERROR_6_REG                      (SOC_AIC_SC_REG_BASE + 0x798)
#define SOC_AIC_SC_REG_AIC_ERROR_MASK_6_REG                 (SOC_AIC_SC_REG_BASE + 0x79C)
...
#define SOC_AIC_SC_REG_UB_USE_TOTAL_SIZE_REG                (SOC_AIC_SC_REG_BASE + 0x11F0)

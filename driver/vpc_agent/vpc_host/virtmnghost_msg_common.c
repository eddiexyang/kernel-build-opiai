...
int vmngh_msg_cluster_recv_common(void *msg_cluster, struct vmng_msg_chan_rx_proc_info *proc_info)
{
    struct vmng_msg_cluster *msg_cluster_in = (struct vmng_msg_cluster *)msg_cluster;
...
int vmngh_msg_common_recv_extension(u32 dev_id, u32 fid, struct vmng_rx_msg_proc_info *proc_info)
{
    int ret;
    u32 cmd;

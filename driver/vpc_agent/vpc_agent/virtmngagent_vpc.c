...
int vmnga_msg_cluster_recv_vpc(void *msg_cluster_in, struct vmng_msg_chan_rx_proc_info *proc_info)
{
...
int vmnga_vpc_msg_send_para_check(u32 dev_id, enum vmng_vpc_type vpc_type, struct vmng_tx_msg_proc_info *tx_info)
{
    if (vpc_type >= VMNG_VPC_TYPE_MAX) {

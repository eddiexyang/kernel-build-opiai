...
#ifdef ESCHED_HOST
#define SCHED_MAX_CHIP_NUM 1 /* helper host (Independent working mode) */
#else
#define SCHED_MAX_CHIP_NUM 1 /* mdc */
#endif
...
#define SCHED_THREAD_TIMEOUT 18000000 /* Thread processing timeout, unit ms */
#else
...
#define SCHED_EXIT_WAIT_TIME 100 /* unit ms */
#define SCHED_PROC_EXIT_WAIT_TIME 2000 /* unit ms */
#define SCHED_PROC_FREE_WAIT_TIME 5000 /* unit ms */
...
struct sched_event {
    ...
    void (*event_finish_func)(u32 devid, u32 subevent_id, const char *msg, u32 msg_len, void *priv);

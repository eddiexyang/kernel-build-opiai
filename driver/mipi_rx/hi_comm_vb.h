...
#define VB_SUPPLEMENT_JPEG_MASK        0x1U
#define VB_SUPPLEMENT_ISPINFO_MASK     0x2U
#define VB_SUPPLEMENT_MOTION_DATA_MASK 0x4U
#define VB_SUPPLEMENT_DNG_MASK         0x8U
...
#define HI_TRACE_VB(level, fmt, ...)                                                    \
    do {                                                                                \
        const hi_char *func = __FUNCTION__;                                             \
        hi_s32 line = __LINE__;                                                         \
        HI_TRACE(level, HI_ID_VB, "[Vb]:%s [Line]:%d " fmt, func, line, ##__VA_ARGS__); \
    } while (0)

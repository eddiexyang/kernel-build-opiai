...
typedef struct {
     ...
     */
    td_bool support_video_format[(td_s32)OT_HDMI_VIDEO_FORMAT_BUTT];
    /*
    ...
    td_bool speaker[(td_s32)OT_HDMI_AUDIO_SPEAKER_BUTT];
    /* Device vendor flag */
    ...
    td_bool support_y420_format[(td_s32)OT_HDMI_VIDEO_FORMAT_BUTT];
    /* the format only support YUV420 */
    td_bool only_support_y420_format[(td_s32)OT_HDMI_VIDEO_FORMAT_BUTT];
    /*
...
typedef struct {
    td_s32 timing_width;
    td_s32 timing_height;
    td_s32 fps;
    td_s32 pattern_color_space;
} ot_hdmi_timing_format;
...
typedef struct {
    td_s32 pattern_mode;
    td_s32 pattern_color_r;
    td_s32 pattern_color_g;
    td_s32 pattern_color_b;
} ot_hdmi_pattern_mode;
